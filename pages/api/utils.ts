...
export const gounbeeeMainAccountID = process.env.NEXT_PUBLIC_GOUNBEEE_MAIN_ACCOUNT_ID as string;
export const account0GanacheImportedID = process.env.NEXT_PUBLIC_ACCOUNT_0_GANACHE_IMPORTED_ID as string;
export const testStatus = process.env.NEXT_PUBLIC_TEST_STATUS as string;
