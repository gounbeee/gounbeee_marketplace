...
import { gounbeeeMainAccountID, account0GanacheImportedID, testStatus } from "../api/utils";
...
const NftCreate: NextPage = () => {
  ...
  const [nftMeta, setNftMeta] = useState<NftMeta>({
    ...
    image: "",
    attributes: [
      {trait_type: "food", value: "0"},
      {trait_type: "clothing", value: "0"},
      {trait_type: "housing", value: "0"},
    ]
  ...
  const handleImage = async (e: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if( testStatus  === 'Development' ) {
        ...
        if(account !== account0GanacheImportedID) {
          console.log("YOU CAN NOT UPLOAD !!!!!")
        ...
        if(account !== gounbeeeMainAccountID) {
          console.log("YOU CAN NOT UPLOAD !!!!!")
          toast.error('YOU ARE NOT ALLOWED TO UPLOAD!"')
          return
        } 
